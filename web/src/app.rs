...
pub fn App() -> impl IntoView {
    ...
    view! {
        ...
        <Stylesheet id="explore" href="/pkg/explore.css"/>
        <Stylesheet id="location-search" href="/pkg/location_search.css"/>
        <Stylesheet id="match-results" href="/pkg/match_results.css"/>
